...
// import { fireStoreDb, firebaseApp } from "../firebase-config";
// // prettier-ignore
...
//   // const storage = getStorage(fireStoreDb);
...
const Create = () => {
  ...
  return (
    <Flex justifyContent={"center"} alignItems={"center"} width="100vw" minHeight={"100vh"} padding="10">
      <Flex width={"80vw"} border="1px" borderColor={"gray.300"} borderRadius={"md"} p={"4"} flexDirection={"column"} alignItems={"center"} justifyContent={"center"} gap={"2"}>
        ...
        <Flex justifyContent={"space-between"} width="full" alignItems={"center"} gap={8} my={4}>
          <Menu>
            <MenuButton as={Button} rightIcon={<FaChevronDown fontSize={15} />} width="full" colorScheme="blue">
              {category}
            </MenuButton>
            <MenuList zIndex={101} width={"md"} shadow="xl">
              {categories &&
          ...
          {!videoAsset ? (
            <FormLabel width={"full"}>
              <Flex direction={"column"} alignItems="center" justifyContent={"center"} height="full" width={"full"}>
                <Flex direction={"column"} alignItems="center" justifyContent={"center"} cursor="pointer" height="full" width={"full"}>
                  {loading ? (
                    <Spinner progress={progress} />
                  ) : (
                    <>
            ...
            <Flex width={"full"} height="full" justifyContent={"center"} alignItems={"center"} bg="black" position={"relative"}>
              <Flex justifyContent={"center"} alignItems={"center"} width={"40px"} height={"40px"} rounded="full" bg={"red"} top={5} right={5} position={"absolute"} cursor={"pointer"} zIndex={10} onClick={deleteImage}>
                <IoTrash fontSize={20} color="white" />
              </Flex>
